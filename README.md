...
Fine-tuning a 1.7B parameter instruction-following language model using Low-Rank Adaptation (LoRA) on consumer hardware (Apple M1, 8GB unified memory). Built as a clean, configurable pipeline designed for reproducibility and easy model swapping.
...
**Technique:** LoRA (r=16, alpha=32) — trains 0.25% of total parameters  
